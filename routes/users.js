...
const userAppSchema = require("../schemas/userApp.json");
 ...
 *
 * Authorization required: admin or the own user
 **/
router.post("/:username/jobs/:id", ensureIsAdminOrUser, async function (req, res, next) {
  try {
